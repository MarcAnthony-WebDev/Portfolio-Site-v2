...
const NavBar = () => {
  ...
  return (
    <div className="nav-container w-full relative col-span-1 row-span-2 h-full bg-accent outline outline-1 outline-neutral-300 dark:bg-accent-dark dark:outline-neutral-500 md:min-h-full">
      ...
      >
        <nav className="nav flex w-full items-center justify-between md:h-full md:flex-col md:items-start md:gap-4">
