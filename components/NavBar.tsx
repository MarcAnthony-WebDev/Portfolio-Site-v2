...
const NavBar = () => {
  return (
    <div className="nav-container relative col-span-1 row-span-2 h-full bg-neutral-50 outline outline-1 outline-neutral-200 md:min-h-full dark:bg-gray-900 dark:outline-neutral-700">
